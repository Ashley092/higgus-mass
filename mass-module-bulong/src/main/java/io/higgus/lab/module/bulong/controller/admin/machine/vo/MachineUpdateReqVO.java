 ...
 * 管理后台 - 机台更新 reqVO
 */
@Schema(description = "管理后台 - 机台更新 reqVO")
@Data
public class MachineUpdateReqVO {

    @Schema(description = "机台ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
