...
/**
 * 管理后台 - 产品工艺明细表创建 reqVO
 */
@Schema(description = "管理后台 - 产品工艺明细表创建 reqVO")
@Data
public class ProductProcessDetailCreateReqVO {

    @Schema(description = "关联工艺ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "工艺ID不能为空")
    private Long processId;

    @Schema(description = "梳栉编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "梳栉编号不能为空")
