...
@Schema(description = "管理后台 - 生产记录更新 reqVO")
@Data
public class ProductionRecordUpdateReqVO {

    @Schema(description = "生产记录序号", requiredMode = Schema.RequiredMode.REQUIRED, example = "PR001")
