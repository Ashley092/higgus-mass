...
/**
 * 管理后台 - 计划-机台关联创建 reqVO
 */
@Schema(description = "管理后台 - 计划-机台关联创建 reqVO")
@Data
public class PlanMachineCreateReqVO {

    @Schema(description = "关联计划ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
